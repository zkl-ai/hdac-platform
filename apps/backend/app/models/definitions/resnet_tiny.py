...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'resnet8x4', 'resnet32x4', 
           'get_optimizer', 'get_criterion']
...
def get_optimizer(model, lr=0.01, momentum=0.9, weight_decay=5e-4):
    """
    Standard SGD optimizer for ResNet on CIFAR
    """
